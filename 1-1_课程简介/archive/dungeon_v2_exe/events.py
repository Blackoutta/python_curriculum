...
# Events
    def calc_dmg(self, current_player, min, max):
        self.damage = random.randint(min, max)
        input("你的HP减少了{}!".format(self.damage))
        current_player.hp -= self.damage
    ...
    def event_1(self, current_player, *arg):
        while True:
            ...
            if choice == '1':
                ...
                if self.check_int(current_player, zombie) and random.choice([True, True, False]):
    ...
    def event_2(self, current_player, *arg):
        while True:
            ...
            if choice == '1':
                ...
                if self.check_int(current_player, fatty) and random.choice([True, True, False]):
